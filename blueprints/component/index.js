...
module.exports = {
  ...
  init() {
    ...
    // I commented this, because blueprints-js does not exist here
    // https://github.com/emberjs/ember.js/blob/master/blueprints/-maybe-polyfill-typescript-blueprints.js
    ...
    this.EMBER_GLIMMER_SET_COMPONENT_TEMPLATE =
      EMBER_GLIMMER_SET_COMPONENT_TEMPLATE || isOctane;
  },
  ...
  afterInstall(options) {
    ...
    if (this.skippedJsFiles.size > 0) {
      ...
      this.ui.writeLine(
        `  ${chalk.cyan('tip')} to add a class, run \`${command}\``
      );
    }
